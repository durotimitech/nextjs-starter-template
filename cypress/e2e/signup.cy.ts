describe('Signup Page', () => {
  ...
  describe('Password Validation', () => {
    ...
    it('should accept matching passwords', () => {
      cy.findByPlaceholderText('Enter your email').type('validuser@test.com')
      cy.findByPlaceholderText('Create a password').type('password123')
      cy.findByPlaceholderText('Confirm your password').type('password123')
      
      cy.findByRole('button', { name: /sign up/i }).click()
      
      // Should show success message or error based on actual response
      // Since we're testing with a real Supabase instance, we might get different responses
  ...
  describe('Authentication Flow', () => {
    it('should show error message for existing email', () => {
      ...
      // Wait for the error to appear in the notification banner
      cy.get('[role="alert"]', { timeout: 10000 }).should('exist')
    })
